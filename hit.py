lambda h: len(h) >= 8 and h[-8:-4] == [h[-8]]*4 and h[-4:] == [h[-4]]*4 and h[-8] != h[-4],
...
def define_patterns():
    ...
    patterns = {
        ...
        "Nhịp 4-4":  & Đối Xứng (Cyclic & Symmetric) ---
...
def create_app():
    ...
    app.TAIXIUMD5_API_URL = "https://apihitclub.up.railway.app/api/taixiu"
